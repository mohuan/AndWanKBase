...
import com.weidingqiang.wanbasek.utils.RxUtil
...
/**
 * 作者：weidingqiang on 2018/4/20 08:59
...
object RxBus {
    ...
    //封装默认订阅
    fun <T> toDefaultFlowable(eventType: Class<T>, act: Consumer<T>): Disposable = bus.ofType(eventType).compose(RxUtil.rxSchedulerHelper<T>()).subscribe(act)
